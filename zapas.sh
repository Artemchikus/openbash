...
echo "1. Установка служб необходимых для работы сервиса Nova и Placement"
...
echo "1. Установка служб необходимых для работы сервиса гипервизора KVM"
...
echo "1. Установка служб необходимых для работы сервиса Neutron"
